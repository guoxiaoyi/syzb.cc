...
class Admin::BannersControllerTest < ActionController::TestCase
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post :create, banner: { order: @banner.order, path: @banner.path, url: @banner.url }
    end

    assert_redirected_to admin_banner_path(assigns(:banner))
  end
  ...
  test "should update banner" do
    patch :update, id: @banner, banner: { order: @banner.order, path: @banner.path, url: @banner.url }
    assert_redirected_to admin_banner_path(assigns(:banner))
  end
