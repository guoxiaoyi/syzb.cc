...
<title>404页面</title>
<link rel="stylesheet" type="text/css" href="/public/css/c_NotFound_detail-01001.css"/>
    ...
    <div class="e_box e_box-000 p_contentBox" >
      <div class="e_box e_box-000 p_disableBox" >
        <div class="e_title e_AssistName-001 p_AssistNameA">
          <div class="font">
            <i class="iconfont"></i>抱歉，这个页面打不开了
          </div>
        </div>
        <div class="e_title e_AssistName-001 p_AssistNameB">
          <div class="font">
            <i class="iconfont"></i>无法执行您的请求，请稍后重试
          </div>
        </div>
      </div>
     ...
     <!--<div class="e_title e_AssistName-001 p_AssistNameC">
        ...
        <div class="e_box e_box-000 p_CommonBtnBox">
            <div class="e_btn e_CommonIconBtn-001 p_CommonBtn p_ZQDL" >
             <!--<div><i class="iconfont"></i>网站运营商服务热线：400-600-5555</div>-->   
              </div>
          ...
          <div class="p_BackTip"><b id="js_skipTime">5</b>秒后自动为您返回到网站首页！</div>
        </div>
      </div>
    </div>
    ...
    <div class="e_box e_box-000 p_bottomBox" >
     <article class="e_Article e_summary-001 p_summaryA">
       <p>据工信部电管［2010］64号文件，对未进行ICP备案或备案信息不完全的网站，进行强制关停。<br>
                          网站运营商作为此网站的运营商，有责任和义务免费协助网站所有者，核实相关信息及办理相关手续。
       </p>
       <p><span style="font-weight:bold">如果网站ICP备案信息已审核通过，如下原因导致页面被禁止访问：</span><br>
       •网站服务已到期，网站运营商已经停止对此网站进行运营服务。<br>
       •网站正处于维护中，网站运营商应网站所有者要求，暂时禁止访问。
       </p>
     </article>
   </div> 
  </div>
