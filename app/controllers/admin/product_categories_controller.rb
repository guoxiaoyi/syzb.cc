class Admin::ProductCategoriesController < Admin::ApplicationController
  ...
  def create
    @item_category = current_manager.item_categories.new(item_category_params.merge(parent_id: @product_category.id))
  ...
  private
    def set_current_manager_product_category
      @product_category = current_manager.item_categories.find_by(cite_key:  'product')
    end
