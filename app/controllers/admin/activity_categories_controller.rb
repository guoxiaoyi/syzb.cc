class Admin::ActivityCategoriesController < Admin::ApplicationController
  ...
  def create
    @item_category = current_manager.item_categories.new(item_category_params.merge(parent_id: @activity_category.id))

    respond_to do |format|
      if @item_category.save
        format.html { redirect_to admin_activity_categories_path}
      else
  ...
  private
    def set_current_manager_activity_category
      @activity_category = current_manager.item_categories.find_by(cite_key:  'activity')
    end
